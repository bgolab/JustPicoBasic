...
- BASIC: INTEGER / FLOAT / STRING data types, arrays, GOSUB & GOTO with labels, FOR / NEXT, WHILE / ENDWHILE, IF / THEN / ELSE / ENDIF, DATA / READ, PAUSE / GETTICK, math & logical expressions, string expression, many build-in functions, built-in editor, flexible formatting (non line oriented, no indentation), etc

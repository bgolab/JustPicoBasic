...
- BASIC: INT / FLOAT / STRING, arrays, GOSUB & GOTO with labels, FOR / WHILE, IF / ELSE, DATA / READ, PAUSE / GETTICK, math & logical expressions, build-in functions, built-in editor, non line oriented, non indentation based, etc
- hardware support: analog / digital read / wite, some OLED modules and Pimoroni Pico Explorer Base (LCD, buttons, piezo)
